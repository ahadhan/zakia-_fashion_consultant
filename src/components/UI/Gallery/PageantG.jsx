      ...
      <div className="heading">
        ...
        <div className={`text-black sm:text-[40px] my-3 mt-16 text-center`}>
          ...
          <h1
            ...
            className='text-[2.2rem] text-gold max-md:text-[1.8rem] font-[600] ' style={{ fontFamily: "Playfair display" }}>Pageant Gallery </h1>
          <div
            data-aos="fade-up"
            data-aos-duration="1500"
            className='w-[8%] h-[5px] bg-primaryColor max-md:w-[35%] mb-8 m-auto'></div>
          <p
            data-aos="fade-down"
            data-aos-duration="1500"
